     ...
     <div className={isVisible ? 'fade-in' : 'fade-out'}>
       <div className="flex flex-col items-between py-12">
          ...
          <div className="flex justify-between">
            ...
            <Card blColor="custom-redlight" trColor="custom-greenlight" percentage={31} shortText="Current Profit Margin" longDesc="With a healthy profit margin, that may end up a second best month ever" />
          </div>
        </div>
     </div>
