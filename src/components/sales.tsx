    ...
    <>
      ...
      <div className="flex flex-col items-between py-12">
          ...
          <div className="flex gap-2">
            <Card blColor="custom-cyan" trColor="custom-sky" percentage={30} shortText="Improved RO1 on ad spend" longDesc="Media buying helped with these results, since it's an important way of attracting clients" />
            <Card blColor="custom-pink" trColor="custom-purple" percentage={50} shortText="More engagement in majority of campains" longDesc="Ads generated significantly more engagement" />
            <Card blColor="custom-redlight" trColor="custom-red" percentage={38} shortText="Surge in Website Traffic" longDesc="As a consequence, website visits skyrocketed, boosted by social media engagement" />
            <Card blColor="custom-redlight" trColor="custom-greenlight" percentage={42} shortText="Surge in Social Channel Traffic" longDesc="The Surge extended to social media, where engagement almost exactly followed website visits" />
          </div>
        </div>
      </div>
    </>
